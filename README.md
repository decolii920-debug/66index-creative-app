# 66index-creative-app · v2.2

> 오늘의 64괘 — 정감록·예수제자·노자·장자의 길 · 개인 만다라 궤적 · 일기 좋아요·댓글
...
| 버전 | 주요 변경 |
|------|-----------|
| **v2.2** | 저장된 일기에 좋아요·댓글 상호작용 추가. 자신의 기록을 다시 되뇌고 시간이 지나 발자국을 이어붙이는 성찰 장치 |
...
| 좋아요     | `like:<diaryId>\|<liker>` | JSON `{kind:'like', diaryId, liker, ts}` | null |
| 댓글       | `cmt:<diaryId>\|<ts>_<rand>` | JSON `{kind:'comment', diaryId, author, body, ts}` | null |
